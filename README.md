...
| Disk (+3) | `.dsk` `.edsk` | ✓ | ✓ | EDSK handles weak sectors, deleted address marks, and copy-protection track layouts whose sector size codes declare more data than a track physically holds |
